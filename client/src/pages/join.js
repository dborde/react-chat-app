    ...
    <div className="row">
      <div className="col-xs">
        <form className="centered-form__box">
          <h2>Join</h2>
          <input name="username" placeholder="Display name" autoComplete="off" value={values.username} onChange={onInputUpdate} />
          <input type="text" list="rooms" name="room" placeholder="Room" autoComplete="off" value={values.room} onChange={onInputUpdate} />
          <datalist id="rooms">
            <Rooms rooms={rooms} />
          </datalist>
